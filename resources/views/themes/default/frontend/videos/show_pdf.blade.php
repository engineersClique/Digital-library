            ...
            <div data-v-0bc416b1="" data-v-7c4d0bf6="" style="position: relative;">
                <nav data-v-0bc416b1="" class="breadcrumbs">
                    ...
                    <ol data-v-0bc416b1="" class="breadcrumbs-visible-items">
                        ...
                        <li data-v-0bc416b1="" class="breadcrumbs-visible-item breadcrumb-visible-item-last">
                            <span data-v-0bc416b1="" dir="auto" style="max-width: 300px;">
                                {{$video->title}}
                            </span>
                        </li>
                    </ol>
...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/vendor/viewer.css') }}">
        <style>
            body{
...
@prepend('scripts')
<script src="{{ asset('js/vendor/compatibility.js') }}"></script>
<script src="{{ asset('js/vendor/l10n.js') }}"></script>
<!--<script src="l10n.js"></script>-->
<!--script src="{{ asset('js/vendor/debugger.js') }}"></script-->
<!--<script src="debugger.js"></script>-->

<!--<script src="pdf.js"></script>-->
            <script src="{{ asset('js/vendor/pdf.js') }}"></script>
<script type="text/javascript">
    var DEFAULT_URL = "{{ route('videos.serve_pdf', $video->id) }}";
    var PDFWORKER_LOCATION="{{asset('js/vendor/pdf.worker.js')}}";
    // var IMAGE_LOCATION="{{ asset('css/../images') }}";
    var IMAGE_LOCATION="{{ asset('/images/') }}";
    var PDFWORKER_LOCATION_JS="{{ asset('js/vendor/pdf.worker') }}";
</script>

<script src="{{ asset('js/vendor/viewer.js') }}"></script>
